                    ...
                    <main class="conteudo">
                        ...
                        <div class="tb-exames">
                            <div class="colunaExameEsqueda">
                                ...
                                ?>
                                <input class="valorExame" id="valorExame1" value="<?php echo $exame['valor']?>"> <?php echo $exame['valor']?></option>
                                <?php
                                }
                                ?>        

                                <input class="valorExame" id="valorExame1" value='<?= $atendimento['exame1'] == $exame["valor"] ? "R$ 45,00" : "";?>' disabled>
                                </div>
